...
# -*- coding: utf-8 -*-
# =====================================
# 基于之前生成的类别 9（TU 肿瘤区域）在 512×512 掩码空间中的 bounding box，
# 将其映射回原始 DICOM 图像空间，
# 并提取该 ROI 的放射组学（Radiomics）特征。
# 直接从DICOM文件中提取影像组学特征
# =====================================
...
# === 配置路径 ===
csv_path = Path(r"K:\PCa_2025\8-Radiomics-PCa\data\external_test\radiomics_csv\bboxes_class9th_patient.csv")
dcm_root = Path(r"K:\PCa_2025\5-Chen_Classify\676+135\test_2_676")
output_csv = Path(r"K:\PCa_2025\8-Radiomics-PCa\data\radiomics_features_9th\radiomics_csv\radiomics_features_t2.csv")
