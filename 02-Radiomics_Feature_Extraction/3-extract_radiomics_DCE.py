...
def main():
    ...
    OUTPUT_CSV = r"K:\PCa_2025\8-Radiomics-PCa\data\external_test\radiomics_csv\radiomics_features_from_bbox_dwi.csv"
    YAML_CONFIG = r"K:\PCa_2025\8-Radiomics-PCa\ML_TZ\extract_radiomics\DCE_custom.yaml"
